...
<%
	session.setAttribute("function", "confirmcancel");
...
<body>
	...
	<a href="index.jsp">Login Page</a> >> User >> <a href="cancellation.jsp">check for Cancellation</a> >> Confirmation
	<h2>Cancellations</h2>
	<fieldset>
		<legend>
			<h3>Confirm the Cancellation</h3>
		</legend>
		<h4>
